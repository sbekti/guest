  ...
  return (
    <Container maxW={'7xl'} p="12">
      <Stack>
        ...
        <Text color={'gray.500'}>
          By checking the box in the registration page, the user agrees to comply with and to be legally bound by the terms of this Policy. If this Policy or any terms of the Service are unacceptable or become unacceptable to the user, the user's only right shall be to terminate his or her use of the Service.
        </Text>
        ...
        { sectionText('The user specifically agrees to the following conditions') }
        <Text color={'gray.500'}>
      ...
      <Stack mt={6}>
        <Text fontWeight={600}>
          By registering to the Service, you acknowledge that you understand and agree to this Policy.
        </Text>
      </Stack>
    </Container>
  );
